...
const ChildNewsUpdates = () => {
    ...
    return (
        <div className="h-full w-full flex flex-col lg:grid lg:grid-cols-12 px-8 py-4">
                    ...
                    <div className="flex flex-row h-[400px] gap-2">
                        <div className="flex flex-row justify-center items-center gap-4">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <Button onClick={onSubmit} className="w-full bg-[#327be9] hover:bg-[#3246e9]" type="submit">
